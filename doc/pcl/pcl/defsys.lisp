...
(defvar *pcl-system-date* "2/16/90  Rainy Day PCL (beta 3)")
...
;  (rel-7-1-patches t            t            ()                rel-7-1)
   ...
   (compat      t                                   t ())
   (precom1     (dfun)                              t (defs low cache fin dfun))
   (precom2     (dfun)                              t (defs low cache fin dfun))
   (precom4     (dfun)                              t (defs low cache fin dfun))
   ))
