...
(progn
(CLines
  "object tc¬cc¬env¬nthcdr (n,tc)"
  "object n,tc;                        "
  "{return (type¬of(tc)==t¬cclosure&&  "
  "         tc->cc.cc¬turbo!=NULL&&    "
  "         type¬of(n)==t¬fixnum)?     "
  "         tc->cc.cc¬turbo[fix(n)]:   " ; assume that n is in bounds
  "         Cnil;                      "
  "}                                   "
  )

(defentry tc-cclosure-env-nthcdr (object object) (object tc¬cc¬env¬nthcdr))

(setf (get 'tc-cclosure-env-nthcdr 'compiler::inline-unsafe)
      '(((fixnum t) t nil nil "(#1)->cc.cc¬turbo[#0]")))
)
...
(define-cstruct-accessor cfun-name  "cfun" "cf¬name"  "object" "(object)" "cf")
(define-cstruct-accessor cfun-self  "cfun" "cf¬self"  "int" "(int (*)())" 
                         "cf")
(define-cstruct-accessor cfun-data  "cfun" "cf¬data"  "object" "(object)" "cf")
(define-cstruct-accessor cfun-start "cfun" "cf¬start" "int" "(char *)" "cf")
(define-cstruct-accessor cfun-size  "cfun" "cf¬size"  "int" "(int)" "cf")
...
(define-cstruct-accessor cclosure-data "cclosure"  "cc¬data"  "object"
                          "(object)" "cc")
(define-cstruct-accessor cclosure-start "cclosure" "cc¬start" "int" 
                         "(char *)" "cc")
...
(CLines
  "object pcl¬coffset (sym,mask,lshift)"
  "object sym,mask,lshift;"
  "{"
  "	return(small¬fixnum(((int)sym >> fix(lshift)) & fix(mask)));"
  "}"
  )

(defentry coffset (object object object) (object pcl¬coffset))
